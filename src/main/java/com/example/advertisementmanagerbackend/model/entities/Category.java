package com.example.advertisementmanagerbackend.model.entities;
...
public class Category {
    ...
    @Pattern(message = "Category's request ID can only contain lowercase latin letters, numbers and \"_\" characters.",
            regexp = "[a-z0-9_]")
